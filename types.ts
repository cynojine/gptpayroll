...
export interface Database {
  public: {
    Tables: {
      ...
      departments: { Row: { id: string; name: string; }; Insert: { id?: string; name: string; }; Update: { id?: string; name?: string; }; };
      job_titles: { Row: { id: string; name: string; }; Insert: { id?: string; name: string; }; Update: { id?: string; name?: string; }; };
      contract_types: { Row: { id: string; name: string; }; Insert: { id?: string; name: string; }; Update: { id?: string; name?: string; }; };
      leave_types: { Row: { id: string; name: string; }; Insert: { id?: string; name: string; }; Update: { id?: string; name?: string; }; };
      tax_bands: {
      ...
      profiles: { Row: { id: string; first_name: string | null; last_name: string | null; role: "admin" | "employee"; }; Insert: { id: string; first_name?: string | null; last_name?: string | null; role?: "admin" | "employee"; }; Update: { id?: string; first_name?: string | null; last_name?: string | null; role?: "admin" | "employee"; }; };
      employees: { 
